...
public final class EventSubscriber {
	...
	public static void registerItems(Register<Item> event) {
		...
		final Item[] itemBlocks = {
                ...
                new ItemBlock(ModBlocks.ASH_TILES_HALF).setRegistryName(ModBlocks.ASH_TILES_HALF.getRegistryName()),
                ...
                new ItemBlock(ModBlocks.IRON_ROOFING_HALF).setRegistryName(ModBlocks.IRON_ROOFING_HALF.getRegistryName()),
                ...
                new ItemBlock(ModBlocks.TILES_HALF).setRegistryName(ModBlocks.TILES_HALF.getRegistryName()),
