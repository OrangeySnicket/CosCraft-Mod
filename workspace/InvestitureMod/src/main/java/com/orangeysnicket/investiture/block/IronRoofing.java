...
public abstract class IronRoofing extends BlockSlab {

	public static final PropertyEnum<Variant> VARIANT = PropertyEnum.<Variant>create("variant", Variant.class);
	
	public IronRoofing(String name) {
		super(Material.IRON);
	...
	public Item getItemDropped(IBlockState state, Random rand, int fortune) {
		return Item.getItemFromBlock(ModBlocks.IRON_ROOFING_HALF);
	}
	
	
	@Override
	public ItemStack getItem(World worldIn, BlockPos pos, IBlockState state) {
		return new ItemStack(ModBlocks.IRON_ROOFING_HALF);
	}
	...
	public static class Double extends IronRoofing
	{
	...
	public static class Half extends IronRoofing
	{
